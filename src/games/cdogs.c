...
static const Source sources[] = {{
    ...
    .url = "https://github.com/cxong/cdogs-sdl/releases/download/2.4.0/C-Dogs.SDL-2.4.0-Linux.tar.gz",
    .dir = "cdogs",
    .archive_type = "tar.gz",
    .bin = "bin/cdogs-sdl",
    .play_cmd = play,
    ...
    .url = "https://github.com/cxong/cdogs-sdl/releases/download/2.2.0/C-Dogs_SDL-2.2.0-Windows-x86_64.zip",
    .dir = "cdogs",
    .archive_type = "zip",
    .bin = "cdogs-sdl.exe",
    .play_cmd = play_win,
